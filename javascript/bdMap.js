...
function ShowMap(objname,options){
	...
	if (this._ismove=="1"){
		...
		var label = new BMap.Label("拖拽到您的位置",{offset:new BMap.Size(0,0)});
	...
	if (this._ismove=="0"){
		...
		//显示窗口设置
		var opts = {width:150,height:100,title : "<font color=green size=3>" + this._title + "</font>"} //窗口标题
		...
		if (this._user !=""){infotxt +=this._user + "<br/>";};
